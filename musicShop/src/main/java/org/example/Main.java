...
public class Main extends Application{
    ...
    public void start(Stage stage){
        ...
        SideField sidefield = new SideField("Вывести все лейблы", "Вывести все альбомы", "Вывести все группы",
                ...
                "определённого жанра с определённым инструментом", "Получить альбомы по группе и лейблу", "Обновить лейб" +
                "л альбома", "Обновить участника группы", "Удалить альбомы определённой личности", "Удалить альбомы лейбла");
